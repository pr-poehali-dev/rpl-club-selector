...
const clubs: Club[] = [
  { id: '1', name: 'Краснодар', league: 'RPL', logo: '' },
  { id: '2', name: 'Зенит', league: 'RPL', logo: '' },
  { id: '3', name: 'ЦСКА', league: 'RPL', logo: '' },
  { id: '4', name: 'Спартак', league: 'RPL', logo: '' },
  { id: '5', name: 'Динамо', league: 'RPL', logo: '' },
  { id: '6', name: 'Локомотив', league: 'RPL', logo: '' },
  { id: '7', name: 'Рубин', league: 'RPL', logo: '' },
  { id: '8', name: 'Ростов', league: 'RPL', logo: '' },
  { id: '9', name: 'Акрон', league: 'RPL', logo: '' },
  { id: '10', name: 'Крылья Советов', league: 'RPL', logo: '' },
  { id: '11', name: 'Ахмат', league: 'RPL', logo: '' },
  { id: '12', name: 'Балтика', league: 'RPL', logo: '' },
  { id: '13', name: 'Торпедо', league: 'RPL', logo: '' },
  { id: '14', name: 'Сочи', league: 'RPL', logo: '' },
  { id: '15', name: 'Пари Нижний Новгород', league: 'RPL', logo: '' },
  { id: '16', name: 'Арсенал', league: 'FNL', logo: '' },
  { id: '17', name: 'Волга', league: 'FNL', logo: '' },
  { id: '18', name: 'Енисей', league: 'FNL', logo: '' },
  { id: '19', name: 'КАМАЗ', league: 'FNL', logo: '' },
  { id: '20', name: 'Нефтехимик', league: 'FNL', logo: '' },
  { id: '21', name: 'Родина', league: 'FNL', logo: '' },
  { id: '22', name: 'Ротор', league: 'FNL', logo: '' },
  { id: '23', name: 'СКА-Хабаровск', league: 'FNL', logo: '' },
  { id: '24', name: 'Сокол', league: 'FNL', logo: '' },
  { id: '25', name: 'Спартак-2', league: 'FNL', logo: '' },
  { id: '26', name: 'Торпедо-2', league: 'FNL', logo: '' },
  { id: '27', name: 'Урал', league: 'FNL', logo: '' },
  { id: '28', name: 'Уфа', league: 'FNL', logo: '' },
  { id: '29', name: 'Факел', league: 'FNL', logo: '' },
  { id: '30', name: 'Чайка', league: 'FNL', logo: '' },
  { id: '31', name: 'Челябинск', league: 'FNL', logo: '' },
  { id: '32', name: 'Черноморец', league: 'FNL', logo: '' },
  { id: '33', name: 'Шинник', league: 'FNL', logo: '' },
];
